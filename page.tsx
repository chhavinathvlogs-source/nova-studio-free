...
export default function Home() {
  const [posts, setPosts] = useState([
    {id: 1, user: "Chhavi", text: "Nova Studio से पहली पोस्ट 🚀"}
  ]);
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white">
      {/* Navbar */}
      <nav className="sticky top-0 p-4 border-b border-gray-700 backdrop-blur-lg bg-slate-900/50">
      ...
      <div className="max-w-2xl mx-auto p-4">
        {/* Post Box */}
        <div className="bg-slate-800/60 backdrop-blur-lg p-4 rounded-2xl border border-gray-700 mb-6">
          <textarea 
            value={newPost}
        ...
        {/* Feed */}
        {posts.map(post => (
          <div key={post.id} className="bg-slate-800/60 backdrop-blur-lg p-4 rounded-2xl border border-gray-700 mb-4">
